...
frame = Frame(root, bg='white', width=600, height=600)
frame.place(relwidth=1, relheight=1)
title = Label(frame, text='Money AI', bg='gray', font=40)
title.pack
btn = Button(frame, text='Log In', bg='white', command=btn_click)
btn.pack()
...
button = RoundedButton(root, 200, 100, 10, 2, 'green', 'white', command=test)
